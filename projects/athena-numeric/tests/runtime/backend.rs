...
use athena_numeric::{NumericBackend, NumericCapability, NumericDomain, NumericOperation, NumericResultMode, PortableBackend, PrecisionKind};
...
fn portable_advertises_directed_interval_enclosure() {
    ...
    assert!(b.supports_operation(&NumericDomain::Interval, NumericOperation::IntervalMul, NumericResultMode::IntervalEnclosure));
}
