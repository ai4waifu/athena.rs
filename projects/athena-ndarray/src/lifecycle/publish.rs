...
use super::{
    alloc::{allocate_array_chunk_id, allocate_array_revision_id, allocate_array_snapshot_id},
    ids::{ArrayChunkId, ArrayId, ArrayRevision, ArrayRevisionId, ArraySnapshot, ArraySnapshotId},
    trace_records::{ArrayChunkRecord, ArrayRevisionRecord, ArraySnapshotRecord, ArrayTraceIndex},
};
...
pub fn finish_array_on_heap(heap: &mut GcHeap, shape: LogicalShape, layout: ArrayLayout) -> Result<PublishedArray, ArrayError> {
