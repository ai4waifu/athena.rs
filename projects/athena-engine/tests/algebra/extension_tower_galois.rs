...
use athena_engine::{
    ...
    apply_field_automorphism, apply_prime_subfield_embedding, canonical_extension_element, canonical_prime_residue,
    execute_galois_with_tables, field_automorphism, frobenius_coords, is_galois_extension,
};
