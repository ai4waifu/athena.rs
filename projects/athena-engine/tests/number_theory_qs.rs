...
use athena_engine::{
    FactorAlgorithms, FactorLimits, FactorizationCompleteness, Integer, dixon_split, factor_integer, fermat_split,
    qs_split, verify_factorization,
};
...
fn fermat_still_splits_close_semiprime() {
    ...
    assert_eq!(n.rem(&d), Integer::zero());
}
