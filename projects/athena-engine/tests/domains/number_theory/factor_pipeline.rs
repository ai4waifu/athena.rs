...
use athena_engine::domains::number_theory::{
    FactorAlgorithms, FactorLimits, FactorizationCompleteness, factor_continue, factor_integer, factorization_to_frontier, verify_factorization,
};
...
fn pollard_p1_splits_smooth_order_semiprime() {
    ...
    limits.policy.algorithms = FactorAlgorithms { trial: false, pollard_rho: false, pollard_p1: true, ecm: false, quadratic_sieve: false };
...
fn resource_budget_marks_resource_limited_then_continue() {
    ...
    tight.policy.algorithms = FactorAlgorithms { trial: false, pollard_rho: false, pollard_p1: false, ecm: false, quadratic_sieve: true };
