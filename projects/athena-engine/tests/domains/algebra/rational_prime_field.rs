...
use athena_engine::domains::{
    algebra::FieldTable,
    field::{
        FieldElementRepr, FieldRequest, add_field_elements, apply_field_embedding, canonical_prime_residue, canonical_rational,
        execute_field_with_table_mut, mul_field_elements,
    },
};
...
fn execute_field_with_table_mut_registers_fields() {
    ...
    assert!(matches!(r, athena_engine::domains::field::FieldResult::Exact { .. }));
