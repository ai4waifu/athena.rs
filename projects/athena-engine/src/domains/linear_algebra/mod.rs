...
pub use exact::{
    ExactDetResult, ExactNormResult, ExactRankResult, ExactRrefResult, ExactSolveResult, ExactTraceResult, det_bareiss, invert_exact, norm2_exact,
    nullspace_exact, rank_exact, rref_rational, solve_exact, trace_exact,
};
...
pub use ops::{cross, dot, elementwise_divide, elementwise_power, flatten_row_major, hadamard, index_scalar, matmul, slice_matrix, transpose};
