//! 群论域分派（Phase 6：置换 presentation + BSGS）。

use athena_types::{Diagnostic, DiagnosticCode};

use crate::algebra::GroupTable;

use super::{
    canonical::{inverse_group_element, multiply_group_elements},
...
pub fn execute_group_with_table(request: GroupRequest, table: &GroupTable) -> GroupResult {
    match request {
        ...
        GroupRequest::PermutationGroup { .. } | GroupRequest::Cyclic { .. } => GroupResult::Unevaluated {
