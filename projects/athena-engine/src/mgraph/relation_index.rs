...
use super::{
    claim::VerifiedClaim,
    fact_log::FactId,
    refs::{RelationRef, RelationStatus, ScopeRef, WitnessRef, scope_to_ref},
};
...
fn relation_status_from_guarantee(g: super::claim::Guarantee) -> RelationStatus {
    use super::claim::Guarantee;
    match g {
